...
import 'package:phone_login_app/Pages/Storage_service(SemPage).dart';
...
class _SemPageState extends State<SemPage> {
  ...
  void initState() {
    ...
    super.initState();
    useurl = '';
    futureFiles = FirebaseStorage.instance.ref('/sem').listAll();
  }
