...
class Storage {
  ...
  Future<firebase_storage.ListResult> listFiles() async {
    firebase_storage.ListResult results =
        await storage.ref('assignments').listAll();

    results.items.forEach((firebase_storage.Reference ref) {
      print('Found Assignments file: $ref');
    });
  ...
  Future<String> downloadURL(String pdfName) async {
    ...
    print("pname=$pname");
    String downloadURL =
        (await storage.ref('assignments/$pdfName').getDownloadURL())!
            .toString();
    print("Download-URL:$downloadURL");
    requrl = '';
    requrl = downloadURL;
    print("requrl in downloadURL:$requrl");
    //await PDFDocument.fromURL(await requrl);
      ...
      body: _loading
          ? Column(
              children: [
                ...
                const Center(
                  child: Text("Fact: Reading reduces stress by 68 percent... ",
                      style: TextStyle(
                          color: Colors.black,
