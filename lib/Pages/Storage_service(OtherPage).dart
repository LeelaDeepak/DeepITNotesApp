...
class Storage {
  ...
  Future<void> uploadFile(
    ...
    try {
      await storage.ref('notes/$fileName').putFile(file);
  ...
  Future<String> downloadURL(String pdfName) async {
    ...
    print("pname=$pname");
    String downloadURL =
        (await storage.ref('notes/$pdfName').getDownloadURL())!.toString();
      ...
      body: _loading
          ? Column(
              children: [
                ...
                const Center(
                  child: Text(
                      "Fact: Fast reading helps to protect your eyes...",
                      style: TextStyle(
                          color: Colors.black,
